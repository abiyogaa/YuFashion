...
@section('title', 'Manage Item Pakaian')
...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col md:flex-row justify-between items-center mb-8">
        ...
        <div class="mt-4 md:mt-0 flex items-center space-x-4">
            <div class="relative">
                <input type="text" id="searchInput" placeholder="Cari item pakaian..." 
            ...
            <a href="{{ route('clothing_items.create') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-all duration-300 transform hover:scale-105">
                <i class="fas fa-plus mr-1"></i> Tambah Item Pakaian
            </a>
        </div>
    </div>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200">
                            ...
                            <td class="py-4 px-6 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <a href="{{ route('clothing_items.edit', $item->id) }}" 
                                    ...
                                    <form action="{{ route('clothing_items.destroy', $item->id) }}" method="POST" 
                        ...
                        <tr>
                            <td colspan="5" class="py-8 px-6 text-center">
                                <div class="flex flex-col items-center justify-center space-y-3">
                                    ...
                                    <span class="font-medium text-gray-500">Tidak ada item pakaian yang tersedia saat ini.</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
